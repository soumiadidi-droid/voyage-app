...
export const DESTINATION_HERO_IMAGE: Partial<Record<string, string>> = {
  ...
  // Photo de Soumia (serris-soumia.jpg) essayée le 15/09/2026, puis retour au lac et au ponton le
  // soir même à sa demande : le lac y est bien plus visible. Gardée dans le dossier pour Instagram.
...
// Val d'Europe (15/09/2026) : le lac de Serris est à gauche de la photo.
