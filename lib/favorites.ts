...
//
// Factory (28/08/2026) : deux favoris distincts et indépendants — destinations (`useFavorites`,
// clé historique "lve-favoris") et établissements/adresses (`usePlaceFavorites`, nouvelle clé) —
// demande explicite de Soumia. Même logique de stockage, juste deux clés localStorage séparées
// pour ne jamais mélanger un id de destination avec un id d'adresse.
function createFavoritesStore(storageKey: string) {
  ...
  return function useThisFavoritesStore() {
...
export const useFavorites = createFavoritesStore("lve-favoris");
export const usePlaceFavorites = createFavoritesStore("lve-favoris-adresses");
