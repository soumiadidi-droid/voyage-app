...
export type VoyageBrut = { slug: string; titre: string; date: string; photos: PhotoBrute[] };
    ...
    <>
            ...
            {v.photos.map((p) => {
              ...
              return (
                <button
                  ...
                  aria-label={`Agrandir la photo — ${v.titre}, ${v.date}`}
                >
      ...
      {actuelle && (
        <div
          role="dialog"
          aria-modal="true"
          aria-label={`${actuelle.voyage.titre}, ${actuelle.voyage.date}`}
        ...
        >
          ...
          <img
            src={actuelle.src}
            alt={`${actuelle.voyage.titre}, ${actuelle.voyage.date}`}
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-display)" }}
          >
            {actuelle.voyage.titre} · {actuelle.voyage.date}
          </p>
